% No7_bin_avg_sigma_tide_fit_CL.m
% NSE
% performs tide fiting of the the x-bin averaged, z-extrapolated (constant-linear) velocity data
% (all sigma levels)
...
%% 04-20-23
date = "042023";
load('BI_adcp_L2_042023_cropped_grid_rotate_binavg_extrap.mat')
%% ------------------------------------------------------------------------
%% 06-28-23
% date = "062823";
% load('BI_adcp_L2_062823_cropped_grid_rotate_binavg_extrap.mat')
%% ------------------------------------------------------------------------
%% 07-13-23
% date = "071323";
% load('BI_adcp_L2_071323_cropped_grid_rotate_binavg_extrap.mat')
%% ------------------------------------------------------------------------
%% 03-15-24
% date = "031524";
...
%% 03-18-24
% date = "031824";
% load('BI_adcp_L2_031824_cropped_grid_rotate_binavg_extrap.mat')
%% ------------------------------------------------------------------------
%% plots
...
along_sigma_cl_clean = along_sigma_cl; % preallocate "cleaned" arrays; 
% these are with the data removed for transects below min criteria.
Tstar_clean = Tstar;
h_binavg_clean = h_binavg;
time_binavg_clean = time_binavg;
...
for n = 1:n_ens  % loop over ensembles (X locations)
    valid_transects = false(n_tran, 1);  % track which transects have any valid data for this ensemble
                                           % logical 0s
    for t = 1:n_tran
        velocity_column = along_sigma_cl(:, n, t);  % all bins at this ensemble + transect
    ...
    if num_valid_transects < 7
        ...
        along_sigma_cl_clean(:,n,:) = NaN;
        Tstar_clean(1,n,:) = NaN;
        h_binavg_clean(1,n,:) = NaN;
        time_binavg_clean(1,n,:) = NaN;
...
for z = 1:n_bins
    for n = 1:n_ens
        ...
        vel = squeeze(along_sigma_cl_clean(z,n,:));     % transects x 1
...
% base = 'C:\Users\nsert\Documents\MATLAB\CZM\2023_Surveys\concatenated data\No7_bin_avg_sigma_tide_fit\constant-linear\excel';
...
along_re = squeeze(along_sigma_cl_clean(zz, ee, :));
...
% filename = fullfile('C:\Users\nsert\Documents\MATLAB\CZM\2023_Surveys\concatenated data\No7_bin_avg_sigma_tide_fit\constant-linear\constituents', ...
...
% 
% filename = fullfile('C:\Users\nsert\Documents\MATLAB\CZM\2023_Surveys\concatenated data\No7_bin_avg_sigma_tide_fit\constant-linear', ...
...
h_mean = squeeze(nanmean(h_binavg_clean,1)); %[sections, #transects]
...
% 
% filename = fullfile('C:\Users\nsert\Documents\MATLAB\CZM\2023_Surveys\concatenated data\No7_bin_avg_sigma_tide_fit\constant-linear\depth contour', ...
...
% filename = fullfile('C:\Users\nsert\Documents\MATLAB\CZM\2023_Surveys\concatenated data\No7_bin_avg_sigma_tide_fit\constant-linear\rmse', ...
...
for z = 1:n_bins
    for n = 1:n_ens
        ...
        vel = squeeze(along_sigma_cl_clean(z,n,:));
...
%     date,'_tide_','fit_','bin-avg_sigma_CL','.mat'),'T_fit_result_all','T_fit_result_all2','T_fit_result_all3',...
%     'Mx_freq','along_sigma_cl_clean','h_binavg_clean','time_binavg_clean',...
